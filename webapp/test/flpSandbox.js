		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Meu currículo em uma aplicação",
									"targetURL": "#sapdevsportmyport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapdevsportmyport-display": {
								"semanticObject": "sapdevsportmyport",
								"action": "display",
								"description": "Meu currículo em uma aplicação",
								"title": "Meu currículo em uma aplicação",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.devs.port.myport",
									"url": sap.ui.require.toUrl("sap/devs/port/myport")
								}
							}
						}
					}
